...
export default class Search extends Component {
  ...
  _searchResult(type, dzxType) {
    this.props.navigation.navigate("ResultManage", {
      type: type,
      dzxType: dzxType
    });
  }
    ...
    return (
      ...
      >
        <View style={styles.item}>
          ...
          <View style={styles.btn2}>
            <TouchableOpacity
              ...
              onPress={() => {
                this._redirectStatistics("dxgc");
              }}
            >
              <Image
                style={styles.cj5Down}
                source={require("../images/icon-chart.png")}
              />
        ...
        <View style={styles.item}>
          <TouchableOpacity
            style={styles.btn1}
            onPress={() => this._searchResult("dzxgc", "2")}
          >
            <Image style={styles.cj5} source={require("../images/cj1.jpg")} />
          ...
          <View style={styles.btn2}>
            <TouchableOpacity
              style={styles.btnmargin}
              onPress={() => this._redirectStatistics("zxgc")}
            >
              <Image
                style={styles.cj5Down}
                source={require("../images/icon-chart.png")}
        ...
        <View style={styles.item}>
          ...
          <View style={styles.btn2}>
            <TouchableOpacity
              style={styles.btnmargin}
              onPress={() => {
                this._redirectStatistics("smaqgc");
              }}
            >
              <Image
                style={styles.cj5Down}
        ...
        <View style={styles.item}>
          ...
          <View style={styles.btn2}>
            <TouchableOpacity
              style={styles.btnmargin}
              onPress={() => this._redirectStatistics("wqgzgc")}
            >
              <Image
                style={styles.cj5Down}
                source={require("../images/icon-chart.png")}
        ...
        <View style={styles.item}>
          <TouchableOpacity
            style={styles.btn1}
            onPress={() => this._searchResult("zhfzgc")}
          >
          ...
          <View style={styles.btn2}>
            <TouchableOpacity
              style={styles.btnmargin}
              onPress={() => this._redirectStatistics("zhfzgc")}
            >
              <Image
                style={styles.cj5Down}
                source={require("../images/icon-chart.png")}
