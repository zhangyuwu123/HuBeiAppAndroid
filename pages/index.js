...
import ResultDetailWithQL from "./search/resultDetailWithQL";
...
const RecordScreen = ({ navigation }) => <Record navigation={navigation} />;
const BridgeScreen = ({ navigation }) => <Bridge navigation={navigation} />;
const StatisticsScreen = ({ navigation }) => (
  <Statistics navigation={navigation} />
);
const ResultScreen = ({ navigation }) => <ResultList navigation={navigation} />;
...
const MySearchScreen = ({ navigation }) => <MySearch navigation={navigation} />;
const ResultDetailScreen = ({ navigation }) => (
  <ResultDetail navigation={navigation} />
);

const ResultDetailWithQLScreen = ({ navigation }) => (
  <ResultDetailWithQL navigation={navigation} />
);
...
const StactNavigatorDemo = StackNavigator(
  {
    ...
    WqResultList: {
      ...
      navigationOptions: {
        ...
        headerRight: (
          <TouchableOpacity
            onPress={() => {
              DeviceEventEmitter.emit("openSearchPanel");
            }}
          >
            <View
              style={{
            ...
            >
              <Text style={{ color: "black", fontSize: 20 }}>筛选</Text>
            </View>
          </TouchableOpacity>
        )
      }
    ...
    ResultDetailWithQLManage: {
      screen: ResultDetailWithQLScreen,
      navigationOptions: {
        headerTitle: "查询结果"
      }
    },
